...
int main()
{
    try
    {
        ...
        cout << "p(A) = " << solution.probability(A) << endl;
        cout << "p(B) = " << solution.probability(B) << endl;
        cout << "p(C) = " << solution.probability(C) << endl;
        cout << "\n";
        ...
        cout << "p(A | C=4) = " << solution_seen_c.probability(A) << endl;
        cout << "p(B | C=4) = " << solution_seen_c.probability(B) << endl;
        cout << "p(C | C=4) = " << solution_seen_c.probability(C) << endl;
        ...
        cout << "p(A | A=1) = " << solution_seen_a.probability(A) << endl;
        cout << "p(B | A=1) = " << solution_seen_a.probability(B) << endl;
        cout << "p(C | A=1) = " << solution_seen_a.probability(C) << endl;
        cout << "\n";
