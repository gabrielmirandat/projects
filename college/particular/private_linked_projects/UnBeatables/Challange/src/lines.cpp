...
namespace lines
{
	...
	//PASS TO HERE AN ANGLE IN DEGRESS!
					 	   ...
					 	   double max_theta_far)
	{
		...
		{
			// std::cout << "angle: " << lines[i][1]*180/CV_PI << std::endl;
			// std::cout << "min_theta_next: " << min_theta_next << std::endl;
			// std::cout << "min_theta_far: " << min_theta_far << std::endl;
			// std::cout << "max_theta_next: " << max_theta_next << std::endl;
			// std::cout << "max_theta_far: " << max_theta_far << "\n" << std::endl;
			// std::cout << "rho: " << lines[i][0] << std::endl;
			// cv::waitKey(500);
			...
			{
				// std::cout << "escolhido! Saindo..";
				std::cout << "\nangle: " << lines[i][1]*180/CV_PI << std::endl;
				std::cout << "rho: " << lines[i][0] << std::endl;
				line = lines[i];
				return i;
			}
