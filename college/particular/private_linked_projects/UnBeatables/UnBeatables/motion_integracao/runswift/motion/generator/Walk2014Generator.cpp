...
#define KICK_STEP_HEIGHT 0.05 // how far to lift kicking foot -----------------> Original 0.045
...
void Walk2014Generator::initialise() {
    ...
    dt = 0.02;                                             // 100(unbeatables ->50) Hz motion thread
...
void Walk2014Generator::makeForwardKickJoints(float kickLean, float kickStepH, float shiftPeriod, float &footh, float &forwardDist,
   ...
   float kickAmp = -0.1; // how far forward the kick should reach 
