/** 
 *  @file vision_implementation.hpp
 *  @version 1.0
 *  @date 01/16/2016
...
class VS 
{
  private:
     ...
     */
    inline void setRhoBase(float value){this->rhoBase = value;};
     ...
     */
    inline void setThetaBase(float value){this->thetaBase = value;};
     ...
     */
    inline void setDiffPosts(float value){this->diffPosts = value;};
     ...
     */
    inline void setBallSide(float value){this->ballSide = value;};
     ...
     */
    inline void setBallDist(float value){this->ballDist = value;};
     ...
     */
    inline void setGoalSize(int value){this->goalSize = value;};
     ...
     */
    inline void setPost1x(int value){this->post1x = value;};
     ...
     */
    inline void setPost2x(int value){this->post2x = value;};
     ...
     */
    float posY2DistanceBottom (int posY) const;
     ...
     *   - output variable must be greater than zero.
     */
    float posY2DistanceTop (int posY) const;
     ...
     */
    void removeBordes(Mat& im) const;
     ...
     */
    void drawLine(Mat& im ,float& rho, float& theta) const;
    ...
    /** 
     * @brief distance in pixels between image pixel (0,0) and line correspondent to the right goal's post.
     */
    int post2x;         
  ...
  public:
     ...
     *   - void
     */
    inline float getRhoBase() const {return this->rhoBase;};
     ...
     *   - void
     */    
    inline float getThetaBase() const {return this->thetaBase;};
     ...
     *   - void
     */
    inline float getDiffPosts() const {return this->diffPosts;};
     ...
     *   - void
     */
    inline float getBallSide() const {return this->ballSide;};
     ...
     *   - void
     */
    inline float getBallDist() const {return this->ballDist;};
     ...
     *   - void
     */
    inline int getGoalSize() const {return this->goalSize;};
     ...
     *   - void
     */
    inline int getPost1x() const {return this->post1x;};
     ...
     *   - void
     */
    inline int getPost2x() const {return this->post2x;};    
