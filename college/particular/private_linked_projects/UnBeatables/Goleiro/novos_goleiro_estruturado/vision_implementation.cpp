/**
 * @file vision_implementation.cpp
 * @author Gabriel Martins de Miranda (UnBeatables Team)
 * @date 01/16/2016
 *
 * @attention Laboratório de Automação e Robótica (LARA)
 * @attention University of Brasilia (UnB)
 */
...
void VS::drawLine(Mat& im ,float& rho, float& theta) const
{
    Point p1,p2;
    double a,b,x0,y0;
