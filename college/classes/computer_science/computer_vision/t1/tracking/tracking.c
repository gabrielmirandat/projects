...
#define  TPL_WIDTH       96      /* template width       */
#define  TPL_HEIGHT      96      /* template height      */
#define  WINDOW_WIDTH    192      /* search window width  */
#define  WINDOW_HEIGHT   192      /* search window height */
