...
segmentada, ou seja, dirigir o que foi proposto em~\cite{Swtboris} para solucionar problemas deste tipo. Observando imagens de
corrida de rua, pudemos concluir algumas situa\c{c}\~oes que frequentemente ocorrem e da\'i formular nosso algoritmo com base 
nestes fatos: a RBN pode possuir algarismos falhados. As larguras dos n\'umeros da RBN n\~ao passam de 30 pixels. H\'a grandes 
varia\c{c}\~oes de ilumina\c{c}\~ao presente numa mesma RBN. As RBNs podem estar dispostas em v\'arias orienta\c{c}\~oes.
Podem haver RBNs de apenas 2 algarismos.
...
following is correct: ``
   ...
   It was introduced by Alpher~\cite{Alpher03}, and subsequently developed by
   Alpher and Fotheringham-Smythe~\cite{Swtboris}, and Alpher \etal~\cite{Alpher04}.''

This is incorrect: ``... subsequently developed by Alpher \etal~\cite{Swtboris} ...''
because reference~\cite{Swtboris} has just two authors.  If you use the
\verb'\etal' macro provided, then you need not worry about double periods
when used at the end of a sentence as in Alpher \etal.

For this citation style, keep multiple citations in numerical (not
chronological) order, so prefer \cite{Swtboris,Alpher03,Authors06} to
\cite{Alpher03,Swtboris,Authors06}.
