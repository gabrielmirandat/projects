/* Modified from get_data1.c -- Parallel Trapezoidal Rule; uses a hand-coded 
...
/* To compile and run:
 *  mpicc e3_get_data1.c -o e3_get_data1
 *  mpiexec -n 4 e3_get_data1, onde -n representa o número de processos criados
 */
