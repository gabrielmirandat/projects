public class CadastroContas {
	...
	public ListaContas listaContasCliente(String cpf) {
		...
		// estamos assumindo que um cliente pode ter mais de uma conta; neste caso, mostramos todas.
	...
	public int renderJuros(String numero, double taxa) {    //retorna se deu certo
		int r = -1;
	...
	public int renderBonus(String numero) { //retorna se deu certo
