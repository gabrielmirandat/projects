...
public class InterfaceTextual {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			System.out.println("Favor fornecer o nome do arquivo de configuracao e tente novamente");
			System.exit(0);
		}
		init(args[0]);
	...
	public static void init(String arqConf) {
		...
		fachada = Fachada.obterInstancia(arqConf);
