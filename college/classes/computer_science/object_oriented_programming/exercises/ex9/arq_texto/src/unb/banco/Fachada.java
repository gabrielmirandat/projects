...
public class Fachada {
	...
	public static Fachada obterInstancia(String arqConf) {
		if (instancia == null) {
			instancia = new Fachada(arqConf);
		}
		return instancia;
	}

	private Fachada(String arqConf) {
		initCadastros(arqConf);
	}

	private void initCadastros(String arqConf) {
		...
		String arqClientes = prop.getProperty("ARQ-REP-CLIENTES");
		String arqContas =prop.getProperty("ARQ-REP-CONTAS");
