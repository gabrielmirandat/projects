...
import unb.banco.dados.cliente.RepositorioClientesFactory;
import unb.banco.dados.conta.ContaNaoExistenteException;
import unb.banco.dados.conta.RepositorioContas;
import unb.banco.dados.conta.RepositorioContasArquivoTexto;
import unb.banco.dados.conta.RepositorioContasFactory;
...
public class Fachada {
	...
	private void initCadastros() {
		//usa factories para configurar os repositorios
		// agora a Fachada nao tem dependencias fortes com a camada de dados.
		// podendo funcionar sem alteracao em codigo com diferentes repositorios
		//RepositorioContas rep = new RepositorioContasArquivoTexto(arqContas,arqClientes);
		RepositorioContas rep = RepositorioContasFactory.create();
		contas = new CadastroContas(rep);
		//RepositorioClientes repClientes = new RepositorioClientesArquivoTexto(arqClientes);
		RepositorioClientes repClientes = RepositorioClientesFactory.create(); 
