...
public class RepositorioContasArquivoTexto implements RepositorioContas {
	...
	public RepositorioContasArquivoTexto() {
		this.nomeArquivo = System.getProperty("user.dir") + File.separator + "contas.txt";
	...
	public Conta[] getContas() {
		...
		try {
			...
			while (linha != null) {
				...
				RepositorioClientesArquivoTexto repClientes = new RepositorioClientesArquivoTexto();
				Cliente cliente;
				try {
