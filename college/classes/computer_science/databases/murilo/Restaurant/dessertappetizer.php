  ...
  '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;"></a>
    ...
    <div class="menu_block">
        <ul>
         ...
         <li class="bt-icon"><a href="Birthday.html">My Birthday</a></li>
...
<div class="content"><div class="ic"></div>
  <div class="container_12">
    <div class="grid_12">
      <h3 class="head2">Choose your free dessert or appetizer!</h3>
    </div>  
             ...
             <div class="div-tabs">
              <div  id="tab-1" class="tab-content gallery1">
                <?php
					...
					$result = mysql_query("SELECT * FROM `menuitem` WHERE `Category_idCategory`=1");
					...
					while ($row = mysql_fetch_array($result)) {
						...
						echo  "<div class='grid_3'> 
								...
								<div class='col2'>
									...
									"<div>
										<span class='calories-inactive' value='0.00' name='".$row{'Name'}."' id='".$row{'idMenuItem'}."'>Calories: ".$row{'Nutritional_Info'}."</span>
									</div>"."$0.00<br>"."
									<div class = 'order'>
										<button class = 'show_button' type='button'>Show Side</button>
										<div class = 'side_order'>
											<form>
												Quantity of items:<input class ='quantity_input noEnter free' type='text' name='quantity'>
											</form>
											<input type='checkbox' class='side1 sides' value='soup'>soup
											<input type='checkbox' class='side2 sides' value='salad'>salad<br>
											<input type='checkbox' class='side3 sides' value='steam rice'>steam rice<br>
											<button class = 'add_button' type='button'>Add To Order</button>
										</div>
              ...
              <div  id="tab-3" class="tab-content gallery3">
                  <?php
					...
					//execute the SQL query and return records
					$result = mysql_query("SELECT * FROM `menuitem` WHERE `Category_idCategory`=3");
					//fetch the data from the database
					while ($row = mysql_fetch_array($result)) {
						...
						echo  "<div class='grid_3'> 
								...
								<div class='col2'>
									...
									<div class = 'order'>
											...
											<button class = 'button_d' type='button'>Add To Order</button>
									</div>
								</div>
							</div>";
					}
