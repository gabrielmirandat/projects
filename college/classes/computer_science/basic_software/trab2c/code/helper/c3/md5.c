...
void md5(uint8_t *initial_msg, size_t initial_len) {
    ...
    for(int i=0,j=0; i<initial_len; i++,j++)
    {
        printf("%04x", initial_msg[i]);
        if(j==10){printf("\n"); j=0;}
    }
    printf("\n\n");
    ...
    // mostra na tela tamanho em bytes do arquivo
    printf("tamanho_padd_bits: %d\n", new_len);
    // mostra mensagem apos padding
    for(int i=0,j=0; i<new_len; i++,j++)
    {
        printf("%04x", msg[i]);
        if(j==10){printf("\n"); j=0;}
    }
    ...
    // mostra na tela tamanho em bytes do arquivo
    printf("tamanho_padd_tam: %d\n", new_len+8);
    // mostra mensagem apos padding
    for(int i=0,j=0; i<new_len+8; i++,j++)
    {
        printf("%04x", msg[i]);
        if(j==10){printf("\n"); j=0;}
    }
