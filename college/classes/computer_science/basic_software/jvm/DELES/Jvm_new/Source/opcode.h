...
- DefiniÃ§Ãµes das instruÃ§Ãµes (opcodes) da JVM
*/
/*======================================================*/
...
// Tconst
// Carregam CONSTANTEes na pilha de operandos.
...
#define bipush FLAG_FINAL
#define sipush 0x11


// ldc*
// carregam CONSTANTEes single (int, float, literal string) ou double word
// (long, double) na pilha
...
// Tload
// carregam valores do vetor de variaveis locais na pilha, ou de arrays
// referenciados no vetor.
// tÃªm como argumento indices para o vetor, ou Ã­ndices implÃ­citos.
#define iload 0x15
#define lload 0x16
#define fload 0x17
#define dload 0x18
...
// Tstore
// grava valores do topo da pilha no vetor de variaveis locais ou em arrays
// referenciados no vetor.
#define istore 0x36
#define lstore 0x37
#define fstore 0x38
...
// instruÃ§Ãµes de manipulaÃ§Ã£o da pilha (descarte, duplicaÃ§Ã£o, troca de
// valores)
#define pop 0x57
#define pop2 0x58
#define dup 0x59
...
// instruÃ§Ãµes lÃ³gico-aritmÃ©ticas que manipulam operandos na pilha
// Tadd
#define iadd 0x60
#define ladd 0x61
#define fadd 0x62
...
// instruÃ§Ãµes que convertem valores presentes na pilha entre diferentes tipos.
#define i2l 0x85
#define i2f 0x86
#define i2d 0x87
#define l2i 0x88
