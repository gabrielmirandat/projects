...
typedef struct jvm 
{
	THREAD *thread_jvm;
	HEAP *heap_jvm;
	METHOD_AREA * method_area_jvm;  
} JVM;
/*==========================================*/


void startJVM(char *, int, char **);
void loadClass(char *, METHOD_AREA **, METHOD_AREA *, JVM *);
void linkClass(METHOD_AREA *, JVM *);
void verifyLink(METHOD_AREA *, JVM *);
void prepareLink(METHOD_AREA *, JVM *);
void resolveLink(ClassFile *, JVM *);
void initializeClass(METHOD_AREA *, JVM *, THREAD *);
void executeMethod(char *, char *, METHOD_AREA *, JVM *, THREAD *, void *, uint16_t, uint32_t *);
void unloadClass(METHOD_AREA *, JVM *);
attribute_info *getCodeAttribute(METHOD_DATA *, METHOD_AREA *);
char *getClassName(METHOD_AREA *);
METHOD_AREA *getSuperClass(ClassFile *, JVM *);
METHOD_AREA *getClass(constant_pool_info *, JVM *);
void exitJVM(JVM *);
VARIABLE *getClassVariable(constant_pool_info *, METHOD_AREA *);
VARIABLE *getInstanceVariable(constant_pool_info *, OBJECT *);
METHOD_DATA *getMethod(char *, char *, METHOD_AREA *, JVM *);
bool isSuperClass(METHOD_AREA *, METHOD_AREA *, JVM *);
...
void freeMethodArea(METHOD_AREA *);
void freeClassData(METHOD_AREA *);
