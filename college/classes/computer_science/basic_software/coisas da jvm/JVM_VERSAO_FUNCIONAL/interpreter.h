...
// ldc_		0x12 a 0x14
//	carregam constantes single (int, float, literal string) ou double word
...
// Tastore	0x4F a 0x56
// grava valores do topo da pilha em arrays referenciados no vetor de variaveis
// locais.
...
// impdep	0xFE e 0xFF
//	(opcodes reservados) instruções que provêem backdoors para implementações
// específicas
