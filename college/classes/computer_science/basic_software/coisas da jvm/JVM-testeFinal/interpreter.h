...
// --  Tem como argumento indices para o vetor ou indices implicitos.
	...
	// --  referenciados pelo vetor de variaveis locais.
...
// --  ou em arrays referenciados pelo vetor de variaveis locais.
...
// --  Instrucoes logico-aritmeticas que manipulam operandos na pilha de operandos.
	...
	// 120 (0x78)    ishl 		> Shift left int (pop 2 inteiros e push resultado) - 5 bits menos significativos
	// 121 (0x79)    lshl 		> Shift left long (pop 1 long e 1 int e push resultado) - 6 bits menos significativos
	// --  De deslocamento a esquerda.
	void Tshl(METHOD_DATA *, THREAD *, JVM *);
	// 122 (0x7a)    ishr 		> Arithmetic shift right int (pop 2 inteiros e push resultado) - extensao de sinal
	// 123 (0x7b)    lshr 		> Arithmetic shift right long (pop 1 long e 1 int e push resultado) - extensao de sinal
	// --  De deslocamento a direita.
	void Tshr(METHOD_DATA *, THREAD *, JVM *);
	// 124 (0x7c)    iushr 		> Logical shift right int (pop 2 inteiros e push resultado) - extensao de zeros
	// 125 (0x7d)    lushr 		> Logical shift right long (pop 1 long e 1 int e push resultado) - extensao de zeros
	...
	// --  De incremento de variavel local.
